...
// window resolution
const unsigned int screenWidth = max_W * 20;
const unsigned int screenHeight = max_H * 20;
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Exercise 6", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBlitFramebuffer(0, 0, max_W * 3, max_H * 3, 0, 0, screenWidth, screenHeight, GL_COLOR_BUFFER_BIT, GL_NEAREST);
